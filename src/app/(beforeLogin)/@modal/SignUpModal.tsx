  ...
  return (
    <>
      <div className='w-screen h-full flex justify-center absolute top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.4)]'>
        <div className='bg-white relative top-[5%] max-w-[80vw] min-w-[600px] rounded-2xl flex flex-col h-[550px]'>
          <div className='pt-9 px-20 pb-5'>
          ...
          <form className='flex flex-col flex-1'>
            ...
            <div className='py-6 px-20'>
              <button
                className='w-full h-[50px] rounded-3xl bg-[rgb(15,20,25)] text-white text-base disabled:opacity-50 hover:bg-[rgb(39,44,48)]'
                disabled
              >
                가입하기
              </button>
